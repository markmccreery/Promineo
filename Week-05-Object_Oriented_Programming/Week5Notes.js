...
let student1 = new Student('Tom', 'Sawyer', '7026299413', 'A');
let student2 = new Student('Sam','Smith','7024270543', 'A');
...
let collectionsSender = new CollectionSender('OVERDUE');
collectionsSender.sendNotification('this is a test collections notification');
*/
/* Handling Exceptions Video
-these can be counted as errors
